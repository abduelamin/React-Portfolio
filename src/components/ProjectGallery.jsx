...
const projects = {
  ...
  "CartSwipe": {
    ...
    "image": cartSwipe,
    "description": "Introducing CartSwipe – an immersive e-commerce platform that elevates online shopping to an engaging experience. Seamlessly integrating React.js, React Hook Form, and JWT authentication, CartSwipe ensures smooth user interactions while showcasing the dynamic synergy of frontend and backend technologies."
  },
  "CryptoPulse": {
    "title": "Crypto Pulse",
    ...
    "image": cryptopulse,
    "description": "Discover real-time cryptocurrency prices with our app. Track top movers, explore the top 20 coins by market cap, and dive into detailed coin info and charts. Stay informed and make smart decisions in the dynamic world of digital currencies."
  },
  "StudyBuddy": {
    "title": "Study Buddy",
